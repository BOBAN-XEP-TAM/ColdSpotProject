...
public class HitContactListener implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        hit_enemy_bullet(fa, fb);
        hit_enemy_wall(fa, fb);
        hit_enemy_player(fa, fb);
    }
    ...
    private void hit_enemy_bullet(Fixture a, Fixture b) {
    ...
    private void hit_enemy_wall(Fixture a, Fixture b) {
    ...
    private void hit_enemy_player(Fixture a, Fixture b) {
